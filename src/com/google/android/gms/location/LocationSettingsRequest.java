 ...
 * This object is used in conjunction with the {@link SettingsApi}.
 */
public class LocationSettingsRequest {
	...
	/**
	 * Returns the list of {@link LocationRequest}s associated with this
	 * request.
	 * 
	...
	public static final class Builder {
		...
		/**
		 * Add a {@link LocationRequest} to the list of requests to check
		 * settings for.
		 * 
		 * @param request
		 *            Request to add to existing list of requests
		...
		/**
		 * Add a collection of {@link LocationRequest}s to the list of requests
		 * to check settings for.
		 * 
		 * @param requests
		 *            Requests to add to existing list of requests.
		...
		/**
		 * Create and return a new {@link LocationSettingsRequest} given the
